...
#Main 
master = Tk()
master.title("Musikk Spiller")

#Labels
Label(master,text="Custom Music PLayer",font=("Calibri",15),fg="black").grid(sticky="N",row=0,padx=120)
Label(master,text="Please select a music track you would like to play",font=("Calibri",12),fg="blue").grid(sticky="N",row=4)
Label(master,text="Volume",font=("Calibri",12),fg="red").grid(sticky="N",row=1)
